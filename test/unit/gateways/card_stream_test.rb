...
class TdBankTest < Test::Unit::TestCase
  include CommStub
  ...
  def test_deprecated_3ds_required
    assert_deprecation_warning(TdBankGateway::THREEDSECURE_REQUIRED_DEPRECATION_MESSAGE) do
      @gateway = TdBankGateway.new(
        :login => 'login',
        :shared_secret => 'secret',
